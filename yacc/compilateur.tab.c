...
{
       0,    35,    35,    44,    48,    54,    71,    72,    73,    74,
      75,    76,    77,    78,    79,    80,    81,    82,    83,    84,
      85,    86,    90,    96,    97,    98,   101,   102,   105,   106,
     107,   108,   109,   112,   113,   114,   117,   120,   126,   129,
     130,   133,   134,   137,   138,   139,   140,   143,   144,   145,
     146,   149,   150,   153,   154,   155,   156,   157,   158,   161,
     165,   166,   170,   187,   188,   189,   193,   194,   197,   205,
     211,   214,   218,   219,   220,   221,   222,   223,   224,   227,
     228,   230,   230,   232,   232,   232,   235,   238,   239,   242,
     243
};
#endif
...
#line 35 "compilateur.y"
  ...
  Laffiche((yyvsp[0].listeQ));
  printf("after1\n");
  Lfree((yyvsp[0].listeQ));
  printf("after2\n");
  }
...
#line 44 "compilateur.y"
  ...
  (yyval.listeQ)=Lconcat((yyvsp[-2].listeQ),(yyvsp[0].listeQ));
}
...
#line 48 "compilateur.y"
  ...
  (yyval.listeQ)=(yyvsp[0].listeQ);
}
#line 1317 "compilateur.tab.c"
    break;

  case 5: /* instruction: ID '=' concatenation  */
#line 54 "compilateur.y"
                                                       { printf("instruction-> ID = concatenation\n");
  quadOP* res= QOcreat_name((yyvsp[-2].strval));
  quadOP* op1=NULL;
  int concat;

  if(ToInt(&concat,(yyvsp[0].strval))){
    op1= QOcreat_cst(concat);
  }else{
    op1= QOcreat_name((yyvsp[0].strval));
  }
...
#line 1702 "compilateur.tab.c"
    break;

  case 63: /* operande: '$' '*'  */
#line 187 "compilateur.y"
                                         { printf("operande-> $ *\n");}
#line 1708 "compilateur.tab.c"
    break;

  case 64: /* operande: '$' '?'  */
#line 188 "compilateur.y"
                                         { printf("operande-> $ ?\n");}
#line 1714 "compilateur.tab.c"
    break;
...
#line 1887 "compilateur.tab.c"
    break;


#line 1891 "compilateur.tab.c"
