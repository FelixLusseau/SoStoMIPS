...
{
       0,    49,    49,    57,    60,    65,    71,    72,    73,    76,
      77,    78,    79,    80,    81,    82,    83,    84,    85,    86,
      87,    88,    93,    98,    99,   100,   103,   104,   107,   108,
     109,   110,   111,   114,   115,   116,   119,   128,   134,   137,
     143,   146,   153,   156,   157,   163,   164,   172,   179,   186,
     203,   233,   234,   237,   238,   239,   240,   241,   242,   245,
     250,   260,   265,   283,   287,   291,   296,   300,   303,   318,
     324,   343,   350,   356,   365,   383,   397,   415,   441,   449,
     463,   468,   468,   470,   470,   470,   473,   476,   477,   480,
     481
};
#endif
...
#line 137 "compilateur.y"
  ...
  quadOP *temp=QOcreat_temp();
  quads *q=Qcreat(Q_OR,temp,(yyvsp[-2].operateur),(yyvsp[0].operateur));
  (yyval.operateur)=temp;
  }
...
#line 146 "compilateur.y"
  ...
  quadOP *temp=QOcreat_temp();
  quads *q=Qcreat(Q_AND,temp,(yyvsp[-2].operateur),(yyvsp[0].operateur));
  (yyval.operateur)=temp;
  }
...
#line 157 "compilateur.y"
  ...
  printf("test_expr3-> ! ( test_expr ) \n");
  quadOP *temp=QOcreat_temp();
  quads *q=Qcreat(Q_IF_NOT,temp,(yyvsp[-1].operateur),NULL);
  (yyval.operateur)=temp;
  }
...
#line 1766 "compilateur.tab.c"
    break;

  case 61: /* operande: ID  */
#line 260 "compilateur.y"
         { 
  printf("operande-> MOT\n");
  (yyval.operateur)=QOcreat(QO_STR,(yyvsp[0].strval),0);
  free((yyvsp[0].strval));
  }
#line 1776 "compilateur.tab.c"
    break;
...
#line 1915 "compilateur.tab.c"
    break;

  case 73: /* operande_entier: '$' '{' ID '[' operande_entier ']' '}'  */
#line 356 "compilateur.y"
                                         { 
  printf("operande_entier-> $ { ID [ operande_entier ] } \n");
  quadOP* tab=QOcreat(QO_TAB,(yyvsp[-4].strval),0);
  quadOP* temp=QOcreat_temp();
...
#line 1952 "compilateur.tab.c"
    break;

  case 75: /* operande_entier: plus_ou_moin '$' '{' ID '}'  */
#line 383 "compilateur.y"
                              { 
...
#line 1994 "compilateur.tab.c"
    break;

  case 77: /* operande_entier: plus_ou_moin '$' ID  */
#line 415 "compilateur.y"
                       { 
