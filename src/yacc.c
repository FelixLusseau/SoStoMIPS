...
{
       0,    53,    53,    56,    64,    72,    83,    89,    90,    91,
     101,   102,   104,   117,   130,   131,   132,   133,   134,   135,
     136,   137,   138,   143,   148,   160,   161,   164,   165,   168,
     169,   170,   171,   172,   175,   176,   177,   180,   189,   195,
     202,   211,   214,   232,   248,   249,   256,   257,   266,   273,
     280,   297,   327,   328,   331,   332,   333,   334,   335,   336,
     339,   344,   354,   359,   377,   381,   385,   390,   394,   397,
     412,   418,   437,   444,   450,   459,   477,   491,   509,   535,
     543,   557,   562,   562,   564,   564,   564,   567,   570,   571,
     574,   575
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* M: %empty  */
#line 53 "./lex-yacc/yacc.y"
          {(yyval.intval)=Lglobal->taille;}
#line 1301 "src/yacc.c"
    break;

  case 3: /* programme: liste_instructions  */
#line 56 "./lex-yacc/yacc.y"
                   {
...
#line 1325 "src/yacc.c"
    break;

  case 5: /* liste_instructions: instruction  */
#line 72 "./lex-yacc/yacc.y"
             {
...
#line 1339 "src/yacc.c"
    break;

  case 6: /* instruction: ID '=' concatenation  */
#line 83 "./lex-yacc/yacc.y"
...
#line 1864 "src/yacc.c"
    break;

  case 62: /* operande: ID  */
#line 354 "./lex-yacc/yacc.y"
         { 
  printf("operande-> MOT\n");
...
#line 2013 "src/yacc.c"
    break;

  case 74: /* operande_entier: '$' '{' ID '[' operande_entier ']' '}'  */
#line 450 "./lex-yacc/yacc.y"
                                         { 
  printf("operande_entier-> $ { ID [ operande_entier ] } \n");
  quadOP* tab=QOcreat(QO_TAB,(yyvsp[-4].strval),0);
  quadOP* temp=QOcreat_temp();
...
#line 2027 "src/yacc.c"
    break;

  case 75: /* operande_entier: '$' ID  */
#line 459 "./lex-yacc/yacc.y"
         { 
...
#line 2050 "src/yacc.c"
    break;

  case 76: /* operande_entier: plus_ou_moin '$' '{' ID '}'  */
#line 477 "./lex-yacc/yacc.y"
                              { 
...
#line 2092 "src/yacc.c"
    break;

  case 78: /* operande_entier: plus_ou_moin '$' ID  */
#line 509 "./lex-yacc/yacc.y"
                       { 
...
#line 2136 "src/yacc.c"
    break;

  case 80: /* operande_entier: plus_ou_moin ID  */
#line 543 "./lex-yacc/yacc.y"
                  { 
  printf("operande_entier-> plus_ou_moin ENTIER\n");
  int entier;
  if(ToInt(&entier,(yyvsp[0].strval))){
...
#line 2155 "src/yacc.c"
    break;

  case 81: /* operande_entier: '(' somme_entiere ')'  */
#line 557 "./lex-yacc/yacc.y"
                        { 
  printf("operande_entier-> ( somme_entiere ) \n");
  (yyval.operateur)=(yyvsp[-1].operateur);
  }
#line 2164 "src/yacc.c"
    break;

  case 82: /* plus_ou_moin: '+'  */
#line 562 "./lex-yacc/yacc.y"
                  {(yyval.intval)=1;}
#line 2170 "src/yacc.c"
    break;

  case 83: /* plus_ou_moin: '-'  */
#line 562 "./lex-yacc/yacc.y"
                                {(yyval.intval)=0;}
#line 2176 "src/yacc.c"
    break;

  case 84: /* fois_div_mod: '*'  */
#line 564 "./lex-yacc/yacc.y"
                  {(yyval.intval)=1;}
